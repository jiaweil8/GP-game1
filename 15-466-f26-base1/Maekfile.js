...
const extract_sprites_objs = [maek.CPP('asset_converter.cpp'), load_save_png_obj];
...
const asset_converter_exe = maek.LINK(extract_sprites_objs, 'dist/asset_converter');

//set the default target to the game (and copy the readme files):
maek.TARGETS = [game_exe,asset_converter_exe, ...copies];
